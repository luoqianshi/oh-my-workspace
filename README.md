...
一个基于多身份角色的 AI 工具与资源导航网站，采用 Neumorphism（软UI）设计风格，从 4445 个浏览器书签中精选 265 个高质量工具，按 4 种身份角色分类管理。
...
│   └── styles/
│       └── themes.css            # 角色强调色 + Neumorphism 阴影工具类 + 移动端优化
└── dist/                         # 生产构建输出
```
...
| 📚 骆谦实 | 紫色 `#8b5cf6` | 75 | 课程学习、竞赛刷题、效率工具、设计工具、实用网站 |
...
- **移动端**：小屏幕下过渡缩短至 `150ms`，禁用 hover 变换，面板从底部滑出
